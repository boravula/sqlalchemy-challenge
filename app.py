...
import sqlalchemy
from sqlalchemy.ext.automap import automap_databse
...
# Reflect an existing datadatabse into a new model.
databse = automap_databse()
# Reflect the tables.
databse.prepare(engine, reflect=True)

# Save reference to the tables.
Measurement = databse.classes.measurement
Station = databse.classes.station
# print(databse.classes.keys())
...
def precipitation():
    ...
    # Calculate the date 1 year ago from the last data point in the datadatabse.
